...
static struct kbuffer_stack kproc_stack = KBUFFER_STACK_INIT(KPROC_MAX_COUNT, (uint8_t*)kproc_buffer, sizeof(struct kproc));

static const struct memory_region kproc_region = {
