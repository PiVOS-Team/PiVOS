...
#define MMU_BLOCK_ENTRY_LEVEL1_OUTPUT_ADDRESS (48 - 18)
#define MMU_BLOCK_ENTRY_LEVEL2_OUTPUT_ADDRESS (48 - 27)
#define MMU_TABLE_ENTRY_NEXT_LEVEL_TABLE_ADDRESS (48 - 36)
#define MMU_PAGE_ENTRY_OUTPUT_ADDRESS (48 - 36)
